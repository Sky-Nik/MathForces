...
\begin{problem}[p<sup>q</sup> + q<sup>p</sup>]
...
\begin{problem}[x<sup>2</sup> + y<sup>2</sup> - 5xy + 4]
	Решите в целых числах $x^2 + y^2 - 5xy + 4 = 0$.
\end{problem}

\begin{problem}[1<sup>n</sup> + 2<sup>n</sup> + &hellip; + n<sup>n</sup>]
...
\begin{problem}[3<sup>x</sup> + 4<sup>y</sup> = 5<sup>z</sup>]
